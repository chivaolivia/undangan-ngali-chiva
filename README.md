...
1. **Unduh proyek atau kloning repositori**:
    ```bash
    git clone [https://chivaolivia.github.io/Undangan-BILAHanjiwaNGALI.git]
    ```

2. **Catatan**: Anda memiliki dua pilihan untuk menggunakan kode sumber ini:
    - **Tanpa Modifikasi**: Buka file [data.js](https://github.com/chivaolivia/Undangan-BILAHanjiwaNGALI/src/assets/data/data.js) untuk langsung menggunakannya.
